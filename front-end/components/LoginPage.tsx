...
function Login() {
  ...
  const handleFormSubmit = async () => {
    console.log(registerEmail, registerName, registerWallet_Address);
      ...
      <div className={Loginstyle.table_container}>
        <div className={Loginstyle.button_row}>
          <div className={Loginstyle.button_cell}>
            <div className={Loginstyle.toggle_buttons}>
              <button
                className={formType === "login" ? Loginstyle.active_button : ""}
              ...
              <button
                className={
                  formType === "register" ? Loginstyle.active_button : ""
                }
        ...
        <div className={Loginstyle.form_row}>
          <div className={Loginstyle.form_cell}>
            {formType === "login" ? (
              <form
                className={Loginstyle.form_group}
              ...
              >
                ...
                <div className={Loginstyle.form_group}>
                  <input
                    ...
                    value={registerWallet_Address}
                    onChange={(e) => setRegisterWallet_Address(e.target.value)}
                    required
                  />
                </div>
                <div className={Loginstyle.form_group}>
